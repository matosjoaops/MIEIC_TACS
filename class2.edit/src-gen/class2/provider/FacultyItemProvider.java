...
/**
 * This is the item provider adapter for a {@link class2.Faculty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FacultyItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Class2Package.Literals.FACULTY__NAME, true, false, false,
	...
	protected void addFieldPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Faculty_field_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Faculty_field_feature",
								"_UI_Faculty_type"),
						Class2Package.Literals.FACULTY__FIELD, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Class2Package.Literals.FACULTY__COURSE);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(Class2Package.Literals.FACULTY__COURSE, Class2Factory.eINSTANCE.createCourse()));
	}
