 ...
 * @generated
 */
public class Class2PackageImpl extends EPackageImpl implements Class2Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see class2.Class2Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Class2PackageImpl() {
		super(eNS_URI, Class2Factory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link Class2Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Class2Package init() {
		if (isInited)
			return (Class2Package) EPackage.Registry.INSTANCE.getEPackage(Class2Package.eNS_URI);

		// Obtain or create and register package
		Object registeredClass2Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		Class2PackageImpl theClass2Package = registeredClass2Package instanceof Class2PackageImpl
				? (Class2PackageImpl) registeredClass2Package
				: new Class2PackageImpl();

		isInited = true;

		// Create package meta-data objects
		theClass2Package.createPackageContents();

		// Initialize created meta-data
		theClass2Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theClass2Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Class2Package.eNS_URI, theClass2Package);
		return theClass2Package;
	}
	 ...
	 * @generated
	 */
	public EAttribute getEdition_Name() {
	 ...
	 * @generated
	 */
	public Class2Factory getClass2Factory() {
		return (Class2Factory) getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getEdition_Name(), ecorePackage.getEString(), "name", null, 0, 1, Edition.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEdition_Professor(), this.getProfessor(), null, "professor", null, 0, -1, Edition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
